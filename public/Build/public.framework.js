...
function _CloseSIOInstance(instanceName) {
...
function _CreateSIOInstance(instanceName, gameObjectName, targetAddress, enableReconnect, payload) {
 var iName = UTF8ToString(instanceName);
 ...
 window.UnitySocketIOInstances[iName].on("connect", function() {
  ...
  SendMessage(window.UnitySocketIOInstanceGameObjects[iName], "UpdateSIOStatus", 1);
 ...
 window.UnitySocketIOInstances[iName].on("disconnect", function(reason) {
  SendMessage(window.UnitySocketIOInstanceGameObjects[iName], "UpdateSIOStatus", 0);
  SendMessage(window.UnitySocketIOInstanceGameObjects[iName], "RaiseSIOEvent", JSON.stringify({
 ...
 window.UnitySocketIOInstances[iName].on("connect_timeout", function() {
  SendMessage(window.UnitySocketIOInstanceGameObjects[iName], "UpdateSIOStatus", 2);
...
function _DestroySIOInstance(instanceName) {
 var iName = UTF8ToString(instanceName);
...
var es = {
 ...
 _callOnError: function(errCallback, id, reason) {
  if (reason) {
   ...
   _free(buffer);
  } else Module["dynCall_vii"](errCallback, [ id, 0 ]);
 },
...
function _ES_Create(urlPtr, withCredentials, onOpen, onMessage, onError) {
 ...
 event.eventImpl.onerror = function(e) {
  ...
  if (e.target.readyState === 0) event.eventImpl.close();
 };
 return es.Set(event);
}
...
function _InstallSocketIO() {
 !function(t, e) {
  ...
  var d = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, y = [ "source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor" ], v = function(t) {
   ...
   return -1 != n && -1 != r && (a.source = e, a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":"), 
   a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), 
   a.ipv6uri = !0), a.pathNames = function(t, e) {
  ...
  var g = m.exports, k = "undefined" != typeof self ? self : "undefined" != typeof window ? window : Function("return this")();
  function b(t) {
   var e = t.xdomain;
   try {
  ...
  function A(t, e) {
   e.useNativeTimers ? (t.setTimeoutFn = _.bind(k), t.clearTimeoutFn = E.bind(k)) : (t.setTimeoutFn = setTimeout.bind(k), 
  ...
  for (var S = {
   type: "error",
   data: "parser error"
  }, B = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === Object.prototype.toString.call(Blob), N = "function" == typeof ArrayBuffer, x = function(t, e, n) {
   var r, o = t.type, i = t.data;
   return B && i instanceof Blob ? e ? n(i) : L(i, n) : N && (i instanceof ArrayBuffer || (r = i, 
   "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? e ? n(i) : L(new Blob([ i ]), n) : n(C[o] + (i || ""));
  }, L = function(t, e) {
  ...
  var D, I = "function" == typeof ArrayBuffer, F = function(t, e) {
   ...
   if (I) {
    var n = function(t) {
     ...
     for (e = 0; e < a; e += 4) n = P[t.charCodeAt(e)], r = P[t.charCodeAt(e + 1)], o = P[t.charCodeAt(e + 2)], 
     i = P[t.charCodeAt(e + 3)], h[c++] = n << 2 | r >> 4, h[c++] = (15 & r) << 4 | o >> 2, 
     h[c++] = (3 & o) << 6 | 63 & i;
     return u;
    }(t);
    return U(n, e);
  ...
  }, V = String.fromCharCode(30), H = function(t) {
   i(o, t);
   var n = h(o);
   function o(t) {
    var r;
    return e(this, o), (r = n.call(this)).writable = !1, A(c(r), t), r.opts = t, r.query = t.query, 
    r.readyState = "", r.socket = t.socket, r;
   }
   return r(o, [ {
    key: "onError",
    value: function(t, e) {
     var n = new Error(t);
     return n.type = "TransportError", n.description = e, f(s(o.prototype), "emit", this).call(this, "error", n), 
     this;
    }
   }, {
    key: "open",
  ...
  var X = J, G = {
   ...
   return r(o, [ {
    ...
    value: function() {
     ...
     !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = X()), this.supportsBinary || t.sid || (t.b64 = 1), 
  ...
  var tt = null != new b({
   ...
   function s(t) {
    ...
    if (e(this, s), r = n.call(this, t), "undefined" != typeof location) {
     ...
     i || (i = o ? "443" : "80"), r.xd = "undefined" != typeof location && t.hostname !== location.hostname || i !== t.port, 
     r.xs = t.secure !== o;
    }
   ...
   function o(t, r) {
    var i;
    return e(this, o), A(c(i = n.call(this)), r), i.opts = r, i.method = r.method || "GET", 
    i.uri = t, i.async = !1 !== r.async, i.data = void 0 !== r.data ? r.data : null, 
    i.create(), i;
   }
   return r(o, [ {
    key: "create",
    value: function() {
     var t = this, e = w(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
     e.xdomain = !!this.opts.xd, e.xscheme = !!this.opts.xs;
     var n = this.xhr = new b(e);
     try {
      n.open(this.method, this.uri, this.async);
      try {
       if (this.opts.extraHeaders) for (var r in n.setDisableHeaderCheck && n.setDisableHeaderCheck(!0), 
       this.opts.extraHeaders) this.opts.extraHeaders.hasOwnProperty(r) && n.setRequestHeader(r, this.opts.extraHeaders[r]);
      } catch (t) {}
      ...
      "withCredentials" in n && (n.withCredentials = this.opts.withCredentials), this.opts.requestTimeout && (n.timeout = this.opts.requestTimeout), 
  ...
  var ot = "function" == typeof Promise && "function" == typeof Promise.resolve ? function(t) {
   ...
   return e(t, 0);
  }, it = k.WebSocket || k.MozWebSocket, st = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase(), at = function(t) {
   i(o, t);
   var n = h(o);
   function o(t) {
    var r;
   ...
   return r(o, [ {
    ...
    value: function() {
     if (this.check()) {
      var t = this.uri(), e = this.opts.protocols, n = st ? {} : w(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
    ...
    value: function() {
     ...
     this.opts.timestampRequests && (t[this.opts.timestampParam] = X()), this.supportsBinary || (t.b64 = 1);
     var r = G.encode(t);
     return e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + n + this.opts.path + (r.length ? "?" + r : "");
    }
   }, {
   ...
   function a(n) {
    ...
    return e(this, a), r = s.call(this), n && "object" === t(n) && (i = n, n = null), 
    n ? (n = v(n), i.hostname = n.host, i.secure = "https" === n.protocol || "wss" === n.protocol, 
    i.port = n.port, n.query && (i.query = n.query)) : i.host && (i.hostname = v(i.host).host), 
    A(c(r), i), r.secure = null != i.secure ? i.secure : "undefined" != typeof location && "https:" === location.protocol, 
    i.hostname && !i.port && (i.port = r.secure ? "443" : "80"), r.hostname = i.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), 
    r.port = i.port || ("undefined" != typeof location && location.port ? location.port : r.secure ? "443" : "80"), 
    r.transports = i.transports || [ "polling", "websocket" ], r.readyState = "", r.writeBuffer = [], 
    r.prevBufferLen = 0, r.opts = o({
     path: "/engine.io",
     agent: !1,
     withCredentials: !1,
     upgrade: !0,
    ...
    }, i), r.opts.path = r.opts.path.replace(/\/$/, "") + "/", "string" == typeof r.opts.query && (r.opts.query = G.decode(r.opts.query)), 
    r.id = null, r.upgrades = null, r.pingInterval = null, r.pingTimeout = null, r.pingTimeoutTimer = null, 
   ...
   return r(a, [ {
    ...
    value: function(t) {
     ...
     var f = function() {
      n.removeListener("open", o), n.removeListener("error", s), n.removeListener("close", c), 
      e.off("close", u), e.off("upgrading", h);
     };
     n.once("open", o), n.once("error", s), n.once("close", c), this.once("close", u), 
     this.once("upgrading", h), n.open();
    }
   }, {
    key: "onOpen",
    value: function() {
     if (this.readyState = "open", a.priorWebsocketSuccess = "websocket" === this.transport.name, 
     this.emitReserved("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t]);
    }
   }, {
    key: "onPacket",
    value: function(t) {
     if ("opening" === this.readyState || "open" === this.readyState || "closing" === this.readyState) switch (this.emitReserved("packet", t), 
     this.emitReserved("heartbeat"), t.type) {
     case "open":
    ...
    key: "onHandshake",
    value: function(t) {
     this.emitReserved("handshake", t), this.id = t.sid, this.transport.query.sid = t.sid, 
     this.upgrades = this.filterUpgrades(t.upgrades), this.pingInterval = t.pingInterval, 
     this.pingTimeout = t.pingTimeout, this.onOpen(), "closed" !== this.readyState && this.resetPingTimeout();
    }
   }, {
    ...
    value: function(t, e, n, r) {
     ...
     n = null), "closing" !== this.readyState && "closed" !== this.readyState) {
      ...
      this.emitReserved("packetCreate", o), this.writeBuffer.push(o), r && this.once("flush", r), 
      this.flush();
     }
    }
   }, {
    ...
    value: function(t, e) {
     ...
     this.readyState = "closed", this.id = null, this.emitReserved("close", t, e), this.writeBuffer = [], 
  ...
  ut.protocol = 4;
  var ht = "function" == typeof ArrayBuffer, ft = Object.prototype.toString, lt = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === ft.call(Blob), pt = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === ft.call(File);
  function dt(t) {
  ...
  function kt(e, n) {
   ...
   if (Array.isArray(e)) for (var r = 0; r < e.length; r++) e[r] = kt(e[r], n); else if ("object" === t(e)) for (var o in e) e.hasOwnProperty(o) && (e[o] = kt(e[o], n));
   return e;
  }
  var bt;
  !function(t) {
  ...
  var wt = function() {
   ...
   return r(t, [ {
    key: "encode",
    value: function(t) {
     return t.type !== bt.EVENT && t.type !== bt.ACK || !yt(t) ? [ this.encodeAsString(t) ] : (t.type = t.type === bt.EVENT ? bt.BINARY_EVENT : bt.BINARY_ACK, 
    ...
    key: "encodeAsBinary",
    value: function(t) {
     var e = vt(t), n = this.encodeAsString(e.packet), r = e.buffers;
   ...
   return r(a, [ {
    ...
    value: function(t) {
     var e;
     if ("string" == typeof t) (e = this.decodeString(t)).type === bt.BINARY_EVENT || e.type === bt.BINARY_ACK ? (this.reconstructor = new Et(e), 
     0 === e.attachments && f(s(a.prototype), "emitReserved", this).call(this, "decoded", e)) : f(s(a.prototype), "emitReserved", this).call(this, "decoded", e); else {
  ...
  var Tt = Object.freeze({
   ...
   function o(t, r, i) {
    var s;
    return e(this, o), (s = n.call(this)).connected = !1, s.disconnected = !0, s.receiveBuffer = [], 
    s.sendBuffer = [], s.ids = 0, s.acks = {}, s.flags = {}, s.io = t, s.nsp = r, i && i.auth && (s.auth = i.auth), 
    s.io._autoConnect && s.open(), s;
   }
   return r(o, [ {
    key: "subEvents",
    value: function() {
    ...
    value: function(t) {
     ...
     return c || (this.connected ? this.packet(o) : this.sendBuffer.push(o)), this.flags = {}, 
     this;
    }
   }, {
    ...
    value: function(t) {
     if (this._anyListeners && this._anyListeners.length) {
      var e, n = p(this._anyListeners.slice());
      try {
       for (n.s(); !(e = n.n()).done; ) {
    ...
    value: function(t) {
     ...
     if (t) {
      for (var e = this._anyListeners, n = 0; n < e.length; n++) if (t === e[n]) return e.splice(n, 1), 
      this;
  ...
  var Bt = function(n) {
   ...
   function s(n, r) {
    var i, a;
    e(this, s), (i = o.call(this)).nsps = {}, i.subs = [], n && "object" === t(n) && (r = n, 
    n = void 0), (r = r || {}).path = r.path || "/socket.io", i.opts = r, A(c(i), r), 
    i.reconnection(!1 !== r.reconnection), i.reconnectionAttempts(r.reconnectionAttempts || 1 / 0), 
    i.reconnectionDelay(r.reconnectionDelay || 1e3), i.reconnectionDelayMax(r.reconnectionDelayMax || 5e3), 
    i.randomizationFactor(null !== (a = r.randomizationFactor) && void 0 !== a ? a : .5), 
    i.backoff = new Ot({
    ...
    var u = r.parser || At;
    return i.encoder = new u.Encoder(), i.decoder = new u.Decoder(), i._autoConnect = !1 !== r.autoConnect, 
    i._autoConnect && i.open(), i;
   }
   return r(s, [ {
    key: "reconnection",
    value: function(t) {
    ...
    key: "onclose",
    value: function(t) {
     this.cleanup(), this.backoff.reset(), this._readyState = "closed", this.emitReserved("close", t), 
  ...
  function xt(e, n) {
   ...
   var r, o = function(t) {
    ...
    n = n || "undefined" != typeof location && location, null == t && (t = n.protocol + "//" + n.host), 
    "string" == typeof t && ("/" === t.charAt(0) && (t = "/" === t.charAt(1) ? n.protocol + t : n.host + t), 
    /^(https?|wss?):\/\//.test(t) || (t = void 0 !== n ? n.protocol + "//" + t : "https://" + t), 
    r = v(t)), r.port || (/^(http|ws)$/.test(r.protocol) ? r.port = "80" : /^(http|ws)s$/.test(r.protocol) && (r.port = "443")), 
    r.path = r.path || "/";
    var o = -1 !== r.host.indexOf(":") ? "[" + r.host + "]" : r.host;
    return r.id = r.protocol + "://" + o + ":" + r.port + e, r.href = r.protocol + "://" + o + (n && n.port === r.port ? "" : ":" + r.port), 
    r;
   }(e, (n = n || {}).path || "/socket.io"), i = o.source, s = o.id, a = o.path, c = Nt[s] && a in Nt[s].nsps;
   return n.forceNew || n["force new connection"] || !1 === n.multiplex || c ? r = new Bt(i, n) : (Nt[s] || (Nt[s] = new Bt(i, n)), 
   r = Nt[s]), o.query && !n.query && (n.query = o.queryKey), r.socket(o.path, n);
  }
  return o(xt, {
   Manager: Bt,
   Socket: Ct,
...
function _SIOEmitNoData(instanceName, eventName) {
 var iName = UTF8ToString(instanceName);
...
function _SIOEmitWithData(instanceName, eventName, data, parseAsJSON) {
 var iName = UTF8ToString(instanceName);
...
function _XHR_Create(method, url, user, passwd, withCredentials) {
 ...
 if (wr.loglevel <= 1) console.log(wr.nextRequestId + " XHR_Create - withCredentials: " + withCredentials + " method: " + _method + " url: " + _url.toString());
...
function _XHR_SetProgressHandler(request, onprogress, onuploadprogress) {
 ...
 if (http) {
  ...
  if (onuploadprogress) http.upload.addEventListener("progress", function http_onprogress(e) {
   ...
   if (e.lengthComputable) Module["dynCall_viii"](onuploadprogress, request, e.loaded, e.total);
  }, true);
 }
}
...
function _XHR_SetRequestHeader(request, header, value) {
 ...
 if (_header != "Cookie") wr.requestInstances[request].setRequestHeader(_header, _value); else {
...
function _XHR_SetResponseHandler(request, onresponse, onerror, ontimeout, onaborted) {
 ...
 http.onload = function http_onload(e) {
  ...
  if (onresponse) {
   ...
   if (!!http.response) responseLength = http.response.byteLength;
...
var asmLibraryArg = {
 "CloseSIOInstance": _CloseSIOInstance,
 "CreateSIOInstance": _CreateSIOInstance,
 "DestroySIOInstance": _DestroySIOInstance,
 "ES_AddEventHandler": _ES_AddEventHandler,
 "ES_Close": _ES_Close,
 "ES_Create": _ES_Create,
 "ES_IsSupported": _ES_IsSupported,
 "ES_Release": _ES_Release,
 "InitializeSIOVars": _InitializeSIOVars,
 "InstallSocketIO": _InstallSocketIO,
 ...
 "SIOEmitNoData": _SIOEmitNoData,
 "SIOEmitWithData": _SIOEmitWithData,
 "WS_Close": _WS_Close,
